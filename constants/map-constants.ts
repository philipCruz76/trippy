import MAPBOX_CATEGORIES from "@/lib/data/MapBoxCategories.json";

export const SEARCH_CATEGORIES = MAPBOX_CATEGORIES.listItems.map((category: any) => category.canonical_id).join(',');
